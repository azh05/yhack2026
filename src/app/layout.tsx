...
export const metadata: Metadata = {
  title: "Love Over War — AI-Powered Global Conflict Intelligence",
  description:
    "Interactive 3D map tracking armed conflicts worldwide with AI analysis, news aggregation, and timelapse visualization.",
};
