...
export default function ChatPanel({ isOpen, onToggle, onMapCommand }: ChatPanelProps) {
  ...
  const [chatMessages, setChatMessages] = useState<{ role: string; text: string }[]>([
    {
      role: 'assistant',
      text: 'Welcome to War AI. Ask me about any conflict zone, region safety, or current events. Try:\n\n• "What is happening in Sudan?"\n• "Is it safe to travel to eastern DRC?"\n• "Show me Myanmar"\n• "Compare Syria vs Yemen"',
    },
  ]);
    ...
    <aside className="fixed right-0 top-14 bottom-[88px] w-[380px] z-30 flex flex-col glass border-l border-white/[0.04] animate-slide-up">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.04]">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-display font-semibold text-white">War AI</h2>
